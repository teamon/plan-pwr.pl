...
describe "Schedule 9" do
  it "should work" do
    ...
    entries[2].building.should == "D-1"
    entries[2].room.should == "29"

    entries[3].course_code.should == "INZ001602S"
    entries[3].course_name.should == "Perspektywy rozwoju systemów i"
    entries[3].course_type.should == "S"
    entries[3].group_code.should == "Z02-27a"
    entries[3].lecturer.should == "Dr inż. Andrzej Siemiński"
    ...
    entries[3].room.should == "202"

    entries[4].course_code.should == "INZ001607S"
    entries[4].course_name.should == "Mobilne systemy informacyjne"
    entries[4].course_type.should == "S"
    entries[4].group_code.should == "Z00-39b"
    entries[4].lecturer.should == "Dr inż. Dariusz Król"
    entries[4].week_day.should == 0
    entries[4].week.should == 1
    entries[4].start_hour.should == 9
    entries[4].start_min.should == 15
    entries[4].end_hour.should == 11
    entries[4].end_min.should == 0
    entries[4].building.should == "A-1"
    entries[4].room.should == "202"

    entries[5].course_code.should == "INZ001601W"
    entries[5].course_name.should == "Metodologia projektowania syst"
    entries[5].course_type.should == "W"
    entries[5].group_code.should == "Z02-26a"
    entries[5].lecturer.should == "Dr inż. Kazimierz Choroś"
    ...
    entries[5].building.should == "B-4"
    entries[5].room.should == "228"

    entries[6].course_code.should == "INZ001601P"
    entries[6].course_name.should == "Metodologia projektowania syst"
    entries[6].course_type.should == "P"
    entries[6].group_code.should == "Z02-25b"
    entries[6].lecturer.should == "Dr inż. Andrzej Siemiński"
    entries[6].week_day.should == 2
    entries[6].week.should == 0
    entries[6].start_hour.should == 17
    entries[6].start_min.should == 5
    entries[6].end_hour.should == 18
    entries[6].end_min.should == 45
    entries[6].building.should == "A-1"
    entries[6].room.should == "248"

    entries[7].course_code.should == "INZ001604W"
    entries[7].course_name.should == "Systemy informacyjne w działal"
    entries[7].course_type.should == "W"
    entries[7].group_code.should == "Z02-31a"
    entries[7].lecturer.should == "Dr inż. Bogdan Trawiński"
    entries[7].week_day.should == 3
    entries[7].week.should == 0
    entries[7].start_hour.should == 7
    entries[7].start_min.should == 30
    entries[7].end_hour.should == 9
    entries[7].end_min.should == 0
    entries[7].building.should == "B-4"
    entries[7].room.should == "228"

    entries[8].course_code.should == "INZ001604S"
    entries[8].course_name.should == "Systemy informacyjne w działal"
    entries[8].course_type.should == "S"
    entries[8].group_code.should == "Z02-30a"
